...
summary captures the essence of the content in a clear and concise manner. 
...
summarization_type = st.sidebar.selectbox("Select Summarization Type:", options=["YouTube Video Summarization", 
                                            "Audio Summarization"], key="summarization_type")
        ...
        if transcript_text:
            ...
            if summary:
                ...
                st.download_button(label="Download Summary", data=summary, file_name="summary.txt", 
                                   mime="text/plain", key="download_summary_youtube")
        ...
        if audio_file:
            ...
            if transcript_text:
                ...
                if summary:
                    ...
                    # Download summary
                    st.download_button(label="Download Summary", data=summary, file_name="summary.txt", 
                                       mime="text/plain", key="download_summary_audio")
